...
public cusNotify() {
    ...
    private boolean sendEmail(String recipient, String subject, String content) {
        ...
        final String password = "aiisbyjwauwhtfcc";
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.println("massage failed");
    ...
    void tableLoad() {
        try {
            pst = con.prepareStatement("SELECT CustomerName,CustomerEmail,Status FROM customer_order where Status='Complete'");
